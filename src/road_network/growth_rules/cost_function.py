...
from src.utilities import parse_image, calculate_distance_between_2_points
...
def height_cost_function(point1, point2, height_map):
    ...
    distance = calculate_distance_between_2_points(point1, point2)
...
def bridge_cost(segment):
    x1, y1 = segment.start_vert.position
    x2, y2 = segment.end_vert.position
    distance = calculate_distance_between_2_points((x1, y1), (x2, y2))
